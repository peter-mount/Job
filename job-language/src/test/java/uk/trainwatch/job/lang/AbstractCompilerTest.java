        ...
        extends AbstractTest
{
            ...
            throws IOException
    {
        try( InputStream is = getScript( n + ".job" ) ) {
            JclScript<Job> script = JclScript.read( new InputStreamReader( is ), Compiler::compile );
            assertNotNull( "No script", script );
            ...
            throws Exception
    {
        ...
        Logger logger = LogHandler.getLogger( "test",
        ...
        scope.addImport( TempResource.class.getName() );
